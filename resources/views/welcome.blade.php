...
<header id="sec-Hom">
  ...
  <div class="container bg-negro mt-2 d-none d-md-block">
    <div id="carouselHome" class="carousel slide " data-ride="carousel" align="center">
      <br />
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4">
        <div class="col-md-12 w-100">
          ...
          <div class="col-md-12 p-2">
            <br>
            <h5 style="text-align: center">Mantenimiento programado</h5>
            <p>¿Usted sabe cu&aacute;ntos Km tiene su Lubricante? Nosotros podemos ayudarle a sacarse
              ...
              email. </p> <a class="btn btn-secondary" href="{{ route('mantenimiento') }}" target="_self">Leer
              m&aacute;s...</a>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-4">
        <div class="col-md-12 w-100">
          ...
          <div class="col-md-12 p-2">
            <br>
            <h5 style="text-align: center">Chiptunning</h5>
            <p>Nuestro Taller a Acumulado mucha informaci&oacute;n a trav&eacute;s de los a&ntilde;os y
              ...
              autom&oacute;vil.
              Inyecci&oacute;n, ABS, Airbag, Pincode, Llaves, Inmobilizador.... </p> <a class="btn btn-secondary" href="{{ route('chiptuning') }}" target="_self">Leer m&aacute;s...</a>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4">
        <div class="col-md-12 w-100">
          ...
          <div class="col-md-12 p-2">
            <br>
            <h5 style="text-align: center">Representaciones</h5>
            <p align="justify">Somos la &uacute;nica empresa del Pa&iacute;s Autorizada a vender los
              ...
              de la Empresa NAPRO ELECTRONIC de BRASIL.&nbsp;</p> <a class="btn btn-secondary" href="{{ route('representacion') }}" target="_self">Leer m&aacute;s...</a>
