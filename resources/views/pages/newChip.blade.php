@extends('layouts.app', ['page' => __('Dashboard - Chiptuning - Alta chiptuning'), 'pageSlug' => 'dashboard'])
...
<div class="card text-center">
  <div class="row">
    <div class="col-md-12 mt-4">
      <div>
        <h3>Alta Chiptuning</h3>
      </div>
      <div class="row">
        <div class="col-md-12">
          <form class="" action="{{ route('chiptuning.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div>
            ...
            <div>
              ...
              <x-text-input type="text" name="modelo" id="modelo" required class="block mt-1 col-md-4" />
              <x-input-error :messages="$errors->get('modelo')" class="mt-2" />
            </div>
            <div>
              <x-input-label class="text-left m-2 col-md-2" for="anio" :value="__('Año')" />
              <x-text-input type="text" name="anio" id="anio" required class="block mt-1 col-md-4" />
              <x-input-error :messages="$errors->get('anio')" class="mt-2" />

            </div>
            <div>
              <x-input-label class="text-left m-2 col-md-2" for="motor" :value="__('Motor')" />
              <x-text-input type="text" name="motor" id="motor" required class="block mt-1 col-md-4" />
              <x-input-error :messages="$errors->get('motor')" class="mt-2" />
            </div>
            <div>
              <x-input-label class="text-left m-2 col-md-2" for="ecu" :value="__('ECU')" />
              <x-text-input type="text" name="ecu" id="ecu" required class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="combustible" id="combustible" required class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="transmicion" id="transmicion" required class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="potencia_original" id="potencia_original" required
            ...
            <div>
              ...
              <x-text-input type="text" name="torque_original" id="torque_original" required
                class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="stage1" id="stage1" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="torque_stg1" id="torque_stg1" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="file" accept="image/*" name="img_st1" id="img_st1" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="stage2" id="stage2" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="torque_stg2" id="torque_stg2" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="file" accept="image/*" name="img_st2" id="img_st2" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="stage3" id="stage3" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="torque_stg3" id="torque_stg3" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="file" accept="image/*" name="img_st3" id="img_st3" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="configuracion_stg1" id="configuracion_stg1" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="configuracion_stg2" id="configuracion_stg2" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="configuracion_stg3" id="configuracion_stg3" class="block mt-1 col-md-4" />
