@extends('layouts.app', ['page' => __('Dashboard - Cursos - Alta Curso'), 'pageSlug' => 'dashboard'])
...
<div class="card text-center">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <form class="" action="{{ route('cursos.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div>
              <x-input-label class="text-left m-2 col-md-2" for="name" :value="__('Titulo')" />
              <x-text-input type="text" name="name" id="name" required class="block mt-1 col-md-4" />
              <x-input-error :messages="$errors->get('name')" class="mt-2" />
            </div>
            <div>
              <x-input-label class="text-left m-2 col-md-2" for="title" :value="__('SubTitulo')" />
              <x-text-input type="text" name="title" id="title" required class="block mt-1 col-md-4" />
              <x-input-error :messages="$errors->get('title')" class="mt-2" />
            </div>
            <div>
              <x-input-label class="text-left m-2 col-md-2" for="videos_curso_cantidad" :value="__('Cantidad Videos')" />
              <x-text-input type=" text" name="videos_curso_cantidad" id="videos_curso_cantidad" required class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="video_demo_Uri" id="video_demo_Uri" class="block mt-1 col-md-4" />
            ...
            <div>
              ...
              <x-text-input type="text" name="coast" id="coast" placeholder="costo -1 sale Proximamente " required autofocus class="block mt-1 col-md-4" autocomplete="coast" />
