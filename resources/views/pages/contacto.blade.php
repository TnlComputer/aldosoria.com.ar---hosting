      ...
      <div class="card-header">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-6">
            <form class="card my-4" action="{{ route('contacto.enviar') }}" method="post" id="formulario">
              @csrf
              ...
              <div>
                ...
                <span>
                  {{-- <a href="https://www.facebook.com/www.aldosoria.com.ar/" class="footerc" target="blank"><img
                      src="https://aldosoria.com.ar/images/Facebook alt 1.png" alt="Facebook"
                      title="Siguenos en Facebook" />
                  </a>
                  <a href="https://twitter.com/aldosoria?lang=es" class="footerc" target="_blank"><img
                      src="https://aldosoria.com.ar/images/Twitter NEW.png" alt="Twitter" title="Siguenos en Twitter" />
                  </a>
                  ...
                  <a href="https://www.youtube.com/channel/UCz1Q_SBgdqp_ULPY8poUM1g" class="footerc" target="blank"><img
                      src="https://aldosoria.com.ar/images/YouTube.png" alt="YouTube" title="Siguenos en YouTube" />
                  </a> --}}
                </span>
                </br></br>
              </div>
